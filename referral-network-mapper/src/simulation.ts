...
export const SAMPLE_DATA = {
  nodes: [
    { id: 'n1', name: 'James Hartley',  type: 'client'       as const, organisation: 'Hartley Capital',  sector: 'Private equity',  estimatedAUM: '>£50m',   engagementScore: 5, referralLikelihood: 4, notes: 'Long-standing client, well connected in PE', introducedBy: null, areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: '', website: '', keyContacts: '', x: 0,    y: 0,    vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n2', name: 'Sarah Chen',     type: 'prospect'     as const, organisation: 'Meridian Ventures', sector: 'Venture capital', estimatedAUM: '£25–50m', engagementScore: 3, referralLikelihood: 2, notes: '', introducedBy: 'n1', areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: '', website: '', keyContacts: '', x: 160,  y: 80,   vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n3', name: 'Robert Okafor',  type: 'referrer'     as const, organisation: 'Okafor & Partners', sector: 'Legal',           estimatedAUM: '',        engagementScore: 4, referralLikelihood: 5, notes: 'Top referrer — family law focus', introducedBy: null, areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: '', website: '', keyContacts: '', x: -160, y: 80,   vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n4', name: 'Emma Blackwood', type: 'prospect'     as const, organisation: 'Blackwood Family',  sector: 'Real estate',     estimatedAUM: '>£50m',   engagementScore: 4, referralLikelihood: 3, notes: '', introducedBy: 'n3', areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: '', website: '', keyContacts: '', x: -220, y: -50,  vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n5', name: 'David Lim',      type: 'client'       as const, organisation: 'Lim Group',         sector: 'Tech founder',    estimatedAUM: '£10–25m', engagementScore: 4, referralLikelihood: 3, notes: '', introducedBy: null, areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: '', website: '', keyContacts: '', x: 220,  y: -50,  vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n6', name: 'Claire Dubois',  type: 'adviser'      as const, organisation: 'Montrose Tax',      sector: 'Accounting',      estimatedAUM: '',        engagementScore: 3, referralLikelihood: 4, notes: 'Tax adviser — good conduit', introducedBy: null, areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: '', website: '', keyContacts: '', x: 0,    y: -180, vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n7', name: 'Marcus Webb',    type: 'prospect'     as const, organisation: 'Webb Industries',   sector: 'Corporate',       estimatedAUM: '£10–25m', engagementScore: 2, referralLikelihood: 1, notes: '', introducedBy: null, areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: '', website: '', keyContacts: '', x: 300,  y: 60,   vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n8', name: 'Alex Morgan',    type: 'jpmorgan'     as const, organisation: 'JP Morgan',         sector: '',                estimatedAUM: '',        engagementScore: 0, referralLikelihood: 0, notes: 'Covers HF clients in London', introducedBy: null, areaOfFocus: 'Hedge Funds', firmsCovered: 'Bridgewater, Man Group', jpmTitle: 'Relationship Manager', jpmEngagement: 'active', industry: '', website: '', keyContacts: '', x: -80,  y: -220, vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
    { id: 'n9', name: 'Hartley Capital', type: 'organisation' as const, organisation: '',                 sector: '',                estimatedAUM: '>£100m',  engagementScore: 0, referralLikelihood: 0, notes: "James Hartley's firm", introducedBy: null, areaOfFocus: '', firmsCovered: '', jpmTitle: '', jpmEngagement: '', industry: 'Asset Management', website: 'hartleycapital.com', keyContacts: 'James Hartley', x: 130, y: -180, vx: 0, vy: 0, fx: 0, fy: 0, fixed: false },
  ],
  edges: [
